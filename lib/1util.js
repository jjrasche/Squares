...
getGames = function getGames(board, query) {
	...
	//console.log('getGames: ', JSON.stringify(parms), ret.length);
	return ret;
}
...
clearTimeOfDateTime = function clearTimeOfDateTime(date) {
	date.setHours(0,0,0,0);
}
maxTimeOfDateTime = function maxTimeOfDateTime(date) {
